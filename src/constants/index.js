...
const WORK_LOCATION = {
  ...
  children: [
    // ▶ Project 1
    {
      ...
      windowPosition: "top-[10vh] left-6", // desktop icon position
      children: [
        {
          id: 1,
          name: "README.txt",
    ...
    // ▶ Project 2
    {
      ...
      windowPosition: "top-[10vh] left-32",
      children: [
        {
          id: 1,
          name: "README.txt",
    ...
    // ▶ Project 5
    {
      ...
      kind: "folder",
      position: "top-10 right-20",
      windowPosition: "top-[32vh] left-32",
      children: [
        {
          id: 1,
          name: "giftlink.txt",
  ...
  children: [
    {
      ...
      description: [
        "Backend-focused Node.js Engineer with 1+ years of professional experience designing and maintaining scalable REST APIs, authentication systems, and PostgreSQL-backed applications in Agile environments.",
        "Experienced in building secure backend services using Node.js, Express, TypeScript, and Prisma ORM, with hands-on experience in Dockerized deployments, automated testing, and CI/CD workflows.",
        "## Soft Skills",
        "My communication style is amazing and I love working in a team. From my experience, I always grow through iterative feedback from my colleagues and discussing best practices to improve my code.",
        "## Hobbies",
        "I love football (and football games), doing LeetCode challenges (a habit I developed with my friend in college), and walking my dog.",
      ],
    },
  ],
};
